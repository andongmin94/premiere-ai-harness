...
현재 버전은 **Core 0.3.1 — Internal Host Qualification Candidate**입니다.
...
```text
dist/PremiereAIHarness-Core-0.3.1-uxp-source/
dist/PremiereAIHarness-Core-0.3.1-uxp-source.manifest.json
```
